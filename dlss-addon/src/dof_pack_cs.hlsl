// Pass 1b, at the DLSS insertion: the half-resolution colour of the DLSS output packed with the circle of confusion
// that dof_coc_cs evaluated at the game's CoC draw - the input of the spiral gather (rgb = colour, a = CoC).
...
RWTexture2D<float4> cocTex   : register(u0);   // rgb = half-res colour, a = signed circle of confusion
