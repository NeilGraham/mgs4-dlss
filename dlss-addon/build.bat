...
cl /nologo /std:c++17 /O2 /MT /EHsc /W3 /DNOMINMAX /D_CRT_SECURE_NO_WARNINGS %INC% /LD src\mgs4_dlss.cpp src\fg.cpp ..\third_party\minhook\src\buffer.c ..\third_party\minhook\src\hook.c ..\third_party\minhook\src\trampoline.c ..\third_party\minhook\src\hde\hde64.c /Fe:..\build\mgs4_dlss.addon64 /Fo:..\build\ /link %LIBS%
