...
#
# This is now a thin shim over tools\mgs4_dlss.ps1, which does the same job with more of it (a scene list, the Cross
...
#
#   mgs4-dlss.bat s00a00l                                    what -Stage s00a00l does
#   mgs4-dlss.bat s00a00l --no-advance                       ... -PressFor 0
#   mgs4-dlss.bat s00a00l --keys "5,ENTER,4,ENTER"           ... -Keys "5,ENTER,4,ENTER"
#   mgs4-dlss.bat --help                                     everything else
#
